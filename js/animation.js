...
const config = {
  name: "Thu oiii,", // actual name of the recipient (Mandatory)

  nickname: "Red Camellia", // nickname(optional)
...
button.addEventListener("click", function () {
  if (button.classList.contains("switch")) {
    ...
    light.play();
    transition(darkroom);
    CTAtext.innerHTML = "Chạm vào để mở cửa";
    setTimeout(function () {
    ...
    door.play();
    transition(hallway);
    CTAtext.innerHTML = "Chạm vào hộp quà để mở";
    setTimeout(function () {
    ...
    document.querySelector(".HBD").textContent = "Chúc cậu sinh nhật vui vẻ ";
